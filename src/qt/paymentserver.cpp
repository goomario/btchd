...
const char* BIP71_MIMETYPE_PAYMENT = "application/btchd-payment";
const char* BIP71_MIMETYPE_PAYMENTACK = "application/btchd-paymentack";
const char* BIP71_MIMETYPE_PAYMENTREQUEST = "application/btchd-paymentrequest";
...
void PaymentServer::handleURIOrFile(const QString& s)
{
    ...
    if (s.startsWith(BITCOIN_IPC_PREFIX, Qt::CaseInsensitive)) // btchd: URI
    {
#if QT_VERSION < 0x050000
        QUrl uri(s);
#else
        ...
        else // normal URI
        {
            ...
            if (GUIUtil::parseBitcoinURI(s, &recipient))
            {
                ...
                Q_EMIT message(tr("URI handling"),
                    tr("URI cannot be parsed! This can be caused by an invalid BTCHD address or malformed URI parameters."),
                    CClientUIInterface::ICON_WARNING);
