    ...
    platformStyle(_platformStyle)
{
    ...
    QString windowTitle = tr("BitcoinHD") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible BitcoinHD command-line options").arg(tr(PACKAGE_NAME)));
...
{
    QString strTitle = tr("BitcoinHD"); // default title
