...
std::string LicenseInfo()
{
    ...
    return CopyrightHolders(_("Copyright (C) %s")) + "\n" +
           ...
           "\n" +
           strprintf(_("This product includes software developed by the OpenSSL Project for use in the OpenSSL Toolkit %s "
                "and cryptographic software written by Eric Young "
                "and UPnP software written by Thomas Bernard "
                "and SQLite software written by SQLite Project %s."),
            "<https://www.openssl.org>", "<https://www.sqlite.org>") +
           "\n";
}
