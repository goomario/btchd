...
static const signed int DEFAULT_CHECKBLOCKS = 72;
...
bool CheckBlock(const CBlock& block, CValidationState& state, const Consensus::Params& consensusParams, bool fCheckWork = true, bool fCheckMerkleRoot = true);
