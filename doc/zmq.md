...
The BTCHD Core daemon can be configured to act as a trusted "border
router", implementing the BTCHD wire protocol and relay, making
...
The ZeroMQ feature in BTCHD Core requires ZeroMQ API version 4.x or
