...
* bco.conf: contains configuration settings for bcod or bco-qt
* bcod.pid: stores the process id of bcod while running
...
* debug.log: contains debug information and general logging generated by bcod or bco-qt
