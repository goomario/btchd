...
This will build btchd-qt as well if the dependencies are met.
...
If you want to build BTCHD-Qt, make sure that the required packages for Qt development
...
Once these are installed, they will be found by configure and a btchd-qt executable will be
built by default.
...
Notes
-----
The release is built with GCC and then "strip btchdd" to strip the debug
...
* Non-executable Stack
    ...
    vulnerable buffers are found. By default, btchd should be built with a non-executable stack
